...
public class UpdateInfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       //password dialog
         ...
         if (photo.equals("")){
             Glide.with(getContext()).load(getResources().getDrawable(R.drawable.account)).into(circleImageView);
         }else {
        ...
        removeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                imageUri = null;
                updatePhoto = true;
                Glide.with(getContext()).load(R.drawable.account).into(circleImageView);
            }
        });
            ...
            if (imageUri != null){
                Glide.with(getContext()).asBitmap().load(imageUri).circleCrop().into(new ImageViewTarget<Bitmap>(circleImageView) {
                    ...
                    protected void setResource(@Nullable Bitmap resource) {
                        ...
                        circleImageView.setImageDrawable(getResources().getDrawable(R.drawable.account));
                    }
