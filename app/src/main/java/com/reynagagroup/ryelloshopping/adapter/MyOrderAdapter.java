                        ...
                        FirebaseFirestore.getInstance().runTransaction(new Transaction.Function<Object>() {
                            ...
                            public Object apply(@NonNull Transaction transaction) throws FirebaseFirestoreException {
                                ...
                                if (ratting != 0){
                                    ...
                                    Long decrease = documentSnapshot.getLong(ratting+1+"_star")-1;
                                    Long total = documentSnapshot.getLong("total_ratings");


                                    Double totalStars = Double.valueOf(0);
                                    for (int x=1;x<6;x++){
                                        if ((x!=starPosition+1)&&(x!=ratting+1)) {
                                            totalStars = totalStars + (documentSnapshot.getLong(x + "_star") * x);
                                        }
                                    }

                                    totalStars = totalStars + (increase*(starPosition+1))+ (decrease*(ratting+1));
                                    ...
                                    transaction.update(documentReference,ratting+1+"_star",decrease);
